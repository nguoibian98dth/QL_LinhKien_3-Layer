...
namespace DAL
{
    public class KiemTra
    {
        ...
        public static bool KiemTraDauVao(string _dl1, string _dl2, string _dl3, string _dl4, string _dl5, string _dl6, string _7)
        {
        ...
        public static bool KiemTra3DauVao(string _dl1, string _dl2, string _dl3)
        {
            if ((_dl1 == "") || (_dl2 == "") || (_dl3 == ""))
            {
                return false;
